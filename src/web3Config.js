...
export const getNftTokenAddress = "0xE44565853259891fC4AAD70121d725e1ce2e92C9";
export const buyNftTokenAddress = "0x36e0AcB4a5642CBE212f538A367C6C0A65E686D8";


export const web3 = new Web3(window.ethereum);

export const getNftTokenContract = new web3.eth.Contract(
	getNftToken,
	getNftTokenAddress
);

export const buyNftTokenContract = new web3.eth.Contract(
	buyNftToken,
	buyNftTokenAddress
);

//두가지 인자 하나는 abi 하나는 주소